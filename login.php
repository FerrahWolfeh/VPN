                ...
                <div class="hero-content text-white"> 
                    <div class="login-container"> 
                        <div class="login-box animated fadeInDown"> 
                            ...
                            <!-- <iframe src="http://free.timeanddate.com/clock/i6ndbiit/n233/tlbr5/fn8/fs11/fc9ff/tct/pct/pa8/tt0/tw1/th1/tb4" frameborder="0" width="201" height="40" allowtransparency="true" style="margin-left: 50px;"></iframe> -->                             
                        </div>                         
                    </div>                     
                    <script type="text/javascript" src="js/plugins/jquery/jquery.min.js"></script>                     
                    <script>
